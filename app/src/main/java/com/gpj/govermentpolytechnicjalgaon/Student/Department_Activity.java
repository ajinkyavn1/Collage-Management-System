...
public class Department_Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            case "ME": URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/ME.php";break;
            case "IT":URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/IT.php"; break;
            case "CE":URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/CE.php";break;
            case  "EEE":URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/EEE.php";break;
            case  "E&tc":URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/E&TC.php";break;
            case  "CO":URL_Data= Constant.ip+"/gpj/Departments/IT/Teacher/Department_activity/CO.php";break;
        }
        loadurl();
    ...
    public void getvalue(JSONArray array) {
        ...
        adapter = new ActivityAdapter(user,this);
